...
- No analytics, advertising SDK, remote account, server processing, automatic cloud upload, or background transmission exists.
...
The privacy manifest declares no tracking, collected data, or required-reason API category. This must be reviewed again whenever frameworks or storage behavior change.
