...
- **Apple Fitness differences:** Apple uses proprietary calibration, sensor fusion, smoothing, and pause behavior. Route-derived distance, moving time, pace, and elevation can differ.
...
- **CSV derived series:** Route CSV reserves smoothed speed and grade columns; the current writer leaves them blank rather than fabricating values not retained as a point series.
